...
@Component({
  selector: 'app-users-profile-page',
  templateUrl: './users-profile-page.component.html',
  styleUrls: ['./users-profile-page.component.css'],
})
export class UsersProfilePageComponent implements OnInit {
